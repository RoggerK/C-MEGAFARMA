            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="nav-superior">
                ...
                <Link to="/"><a class=" nav-link text-light" aria-current="page" >Inicio</a></Link>
                  ...
                  Administrar</a>
                  <div id="drop-down" >
                  <Link class="nav-link text-white" to="/marcaMant"><a  class="clinks"><img class="icono bg-light" src="img/iconos/laboratorio.png" alt=""/> Marca</a></Link>
                      <Link class="nav-link text-white" to="/productoMant"><a class="clinks"><img class="icono bg-light" src="img/iconos/productos.png" alt=""/> Producto</a></Link>
                      <Link class="nav-link text-white" to="/categoriaMant"><a  class="clinks"><img class="icono bg-light" src="img/iconos/categorias.png" alt=""/> Categorias</a></Link>        
                  </div>
                </div>
              </div>
            </div>
